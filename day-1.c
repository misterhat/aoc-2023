...
/* grab the first and last digit (either a digit or a number name) and find
 * the sum */
uint32_t get_line_sum(const char *line) {
    ...
    /* initially set with the number name ints, but overriden if digits
